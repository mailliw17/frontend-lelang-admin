...
export class PenjualDataService {
  ...
  createSeller(newsel: Seller): Observable<Seller> {
    return this.httpClient.post<Seller>(this.url_create, newsel, this.httpOptions_base)
  }
  ...
  updateSeller(id: string, updatedseller: Seller): Observable<Seller> {
    ...
    return this.httpClient.put<Seller>(url, updatedseller, this.httpOptions_base)
  }
}

...
export class BranchDataService {
  ...
  getSellers(): Observable<Seller[]> {
    return this.httpClient.get<Seller[]>(this.url_sellers, this.httpOptions_base)
  }
  ...
  createBranch(newbranch: Branch): Observable<Branch> {
    return this.httpClient.post<Branch>(this.url_create, newbranch, this.httpOptions_base)
  }

  updateBranch(id: string, updatedBranch: Branch): Observable<Branch> {
    var url = this.url_update.toString().concat(id)
    console.log(url)
    return this.httpClient.put<Branch>(url, updatedBranch, this.httpOptions_base)
  }
}

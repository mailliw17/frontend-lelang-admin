...
export class LelangDataService {
  ...
  AddLelang(newlel: Lelang, tempimg:any[],attachment:any): Observable<Lelang> {
    var temp: any = newlel
  ...
  getOrganizer(): Observable<Organizer[]> {
    ...
    return this.httpClient.get<Organizer[]>(this.url_org, this.httpOptions_base)

  }

  getSeller(): Observable<Seller[]> {
    return this.httpClient.get<Seller[]>(this.url_seller, this.httpOptions_base)
  ...
  getBranch(sellerid:any): Observable<Branch[]> {
    ...
    var url = this.url_branchbysel.toString().concat(sellerid).concat(x.toString())
    return this.httpClient.get<Branch[]>(url, this.httpOptions_base)
  }

  updateLel(id: string, updatedlel: Lelang, tempimg:any[], attachment:any): Observable<Lelang> {
    console.log(tempimg)
  ...
  filegetterimg(url:string):Promise<Blob>{
    return firstValueFrom( this.httpClient.get<Blob>(url,{responseType: 'blob' as 'json'}))
  }

...
export class LotLelangEditComponent implements OnInit {
  ...
  leleditform(){
    this.Leledit = this.fb.group({
      ...
      leljoinenddate:  ['', Validators.compose([Validators.required,validatedate,this.validateall.bind(this)])],
      lelbidstart:  ['', Validators.compose([Validators.required,validatedate,this.validateall.bind(this)])],
      lelenddate:  ['', Validators.compose([Validators.required,validatedate,this.validateall.bind(this)])],
      lelorg:  [''],
      lelseller:  [''],
      lelbranch:  [''],

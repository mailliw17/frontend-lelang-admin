...
export class LotLelangTambahComponent implements OnInit {
  ...
  leladdform(){
    this.Leladd = this.fb.group({
      ...
      lelinitialprice:  ['', Validators.compose([Validators.required, Validators.pattern("^([1-9])[- +()0-9]+")])],
      lelbidtype:  ['', Validators.required],
      lelcolaqty: ['',Validators.compose([Validators.required, Validators.pattern("^([1-9])[- +()0-9]+")])],
      leljoinenddate:  ['', Validators.compose([Validators.required,this.validateall.bind(this),validatedate])],
      lelbidstart:  ['', Validators.compose([Validators.required,this.validateall.bind(this),validatedate])],
      lelenddate:  ['', Validators.compose([Validators.required,this.validateall.bind(this),validatedate])],
